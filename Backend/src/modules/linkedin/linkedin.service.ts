...
import { LINKEDIN_GENERATOR_SYSTEM_PROMPT, buildLinkedInPrompt } from "#/ai/prompts/linkedin-generator.prompt.js";
import { SESSION_STATES } from "#/config/constants.js";
import { ILinkedInDraft, LinkedInDraft } from "#/modules/linkedin/linkedin.model.js";
import { linkedInDraftSchema } from "#/modules/linkedin/linkedin.validator.js";
import { Session } from "#/modules/session/session.model.js";
import { AppError } from "#/shared/errors/AppError.js";
import { Types } from "mongoose";


export const generateLinkedInDraft = async (sessionId: string, userId: Types.ObjectId): Promise<ILinkedInDraft> => {
...
export const getLinkedInDraftsForUser = async (userId: Types.ObjectId): Promise<ILinkedInDraft[]> => {
